import { mockDevices, mockNodes } from '@/data/mockData';
  ...
  const permissions = [
    {
      ...
      icon: Shield,
      color: 'warning',
      entities: mockDevices.filter(d => d.permission === 'admin').length + 2,
    },
    {
      role: 'Write',
      ...
      icon: Edit,
      color: 'accent',
      entities: mockDevices.filter(d => d.permission === 'write').length,
    },
    {
      role: 'Read',
      ...
      icon: Eye,
      color: 'primary',
      entities: mockDevices.filter(d => d.permission === 'read').length + 1,
    },
  ];
