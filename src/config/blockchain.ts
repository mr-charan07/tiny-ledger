...
export const CONTRACT_ABI = [
  ...
  "function getDataRecord(uint256 _id) view returns (tuple(uint256 id, address deviceAddress, string deviceName, string dataType, int256 value, uint256 timestamp, bytes32 signature))",
  "function getRecentData(uint256 _count) view returns (tuple(uint256 id, address deviceAddress, string deviceName, string dataType, int256 value, uint256 timestamp, bytes32 signature)[])",
  "function getAllDevices() view returns (tuple(address deviceAddress, string name, string deviceType, bool isActive, uint256 registeredAt, uint256 transactionCount, uint8 permission)[])",
  "function getAllNodes() view returns (tuple(address nodeAddress, string name, bool isValidator, bool isActive, uint256 blocksValidated, uint256 lastSeen)[])",
  "function getDevice(address _deviceAddress) view returns (tuple(address deviceAddress, string name, string deviceType, bool isActive, uint256 registeredAt, uint256 transactionCount, uint8 permission))",
  "function getNode(address _nodeAddress) view returns (tuple(address nodeAddress, string name, bool isValidator, bool isActive, uint256 blocksValidated, uint256 lastSeen))",
  ...
  // Write functions
  "function registerDevice(address _deviceAddress, string _name, string _deviceType, uint8 _permission)",
  ...
  "function registerNode(address _nodeAddress, string _name, bool _isValidator)",
  "function setNodeStatus(address _nodeAddress, bool _isActive)",
  "function updateNodeLastSeen(address _nodeAddress)",
  "function recordData(string _deviceName, string _dataType, int256 _value, bytes32 _signature) returns (uint256)",
